...
class ConditionTest(TestCase):
    ...
    def test_4_processes(self):
        self.assertEqual(os.system("mpiexec -n 4 python ../dev/mpi_app.py"), 0)

    def test_6_processes(self):
        self.assertEqual(os.system("mpiexec -n 6 python ../dev/mpi_app.py"), 0)

    def test_8_processes(self):
        self.assertEqual(os.system("mpiexec -n 8 python ../dev/mpi_app.py"), 0)
